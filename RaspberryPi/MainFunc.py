...
def main(nameInput , nameOutput):
    ...
    if len(listOfPossiblePlates) == 0:                          # if no plates were found
        ...
        # cv2.imshow(nameOutput, imgOriginalScene)                # re-show scene image

        cv2.imwrite(nameOutput, imgOriginalScene)           # write image out to file
